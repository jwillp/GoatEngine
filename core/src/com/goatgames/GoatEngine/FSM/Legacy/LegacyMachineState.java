...
/**
 * State of an LegacyFiniteStateMachine
 */
public class LegacyMachineState {
    ...
    String id;                          // A Unique ID for that state
     ...
     */
    public LegacyMachineState(String id, StateFlag flag, String name, String description, String neighbours){
        this.id = id;
        this.flag = flag;
        this.name = name;
     ...
     * @param state
     */
    public LegacyMachineState(XmlReader.Element state) {
        this(
