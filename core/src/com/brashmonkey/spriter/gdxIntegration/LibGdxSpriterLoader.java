...
public class LibGdxSpriterLoader extends Loader<Sprite> implements Disposable{
    ...
    public LibGdxSpriterLoader(Data data){
        this(data, true);
    }

    public LibGdxSpriterLoader(Data data, boolean pack){
        this(data, standardAtlasWidth, standardAtlasHeight);
        this.pack = pack;
    }

    public LibGdxSpriterLoader(Data data, int atlasWidth, int atlasHeight) {
        super(data);
        this.pack = true;
